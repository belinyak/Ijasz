...
namespace Ijasz2.Adatbazis.Oklevel {
    public static class Oklevel {
        public static ObservableCollection<Sablon> Load() {
            var value = new ObservableCollection<Sablon>();
            ...
            while (reader.Read()) {
                ...
                value.Add(new Sablon {
                    ...
                    Versenysorozat = reader.IsDBNull(++index)
                        ? null
                        : new SablonMezo {
                            X = reader.GetInt32(index),
                            Y = reader.GetInt32(++index),
                    ...
                    Helyezes = reader.IsDBNull(++index)
                        ? null
                        : new SablonMezo {
                            X = reader.GetInt32(index),
                            Y = reader.GetInt32(++index),
                    ...
                    Egyesulet = reader.IsDBNull(++index)
                        ? null
                        : new SablonMezo {
                            X = reader.GetInt32(index),
                            Y = reader.GetInt32(++index),
                    ...
                    Korosztaly = reader.IsDBNull(++index)
                        ? null
                        : new SablonMezo {
                            X = reader.GetInt32(index),
                            Y = reader.GetInt32(++index),
                    ...
                    InduloNem = reader.IsDBNull(++index)
                        ? null
                        : new SablonMezo {
                            X = reader.GetInt32(index),
                            Y = reader.GetInt32(++index),
        ...
        public static void Add(Sablon sablon) {
            Database.Connection.Open();
            var command = Database.Connection.CreateCommand();
