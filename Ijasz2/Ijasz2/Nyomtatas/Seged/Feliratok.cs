...
namespace Ijasz2.Nyomtatas.Seged {
    internal static class Feliratok {
        internal static string HeadLineCsapatlista = "C S A P A T L I S T A";
        internal static string VersenyMegnevezes = "Verseny: ";
        internal static string VersenyDatum = "Dátum: ";
        internal static string OsszesPont = "Összes pont: ";
