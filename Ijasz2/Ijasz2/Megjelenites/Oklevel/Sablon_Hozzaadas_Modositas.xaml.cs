    ...
    public partial class Sablon_Hozzaadas_Modositas {
        ...
        private bool IsValid() {
            ...
            if (txtVersenySze.Text != "") {
                ...
                try {
                    Convert.ToInt32(txtVersenySze.Text);
                }
                catch {
                ...
                try {
                    Convert.ToInt32(txtVersenyMa.Text);
                }
                catch {
                    txtVersenyMa.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtVersenyHo.Text);
                }
                catch {
                    txtVersenyHo.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtVersenyMe.Text);
                }
                catch {
                    txtVersenyMe.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
            ...
            if (txtVersenySorozatSze.Text != "") {
                ...
                try {
                    Convert.ToInt32(txtVersenySorozatSze.Text);
                }
                catch {
                ...
                try {
                    Convert.ToInt32(txtVersenySorozatMa.Text);
                }
                catch {
                    txtVersenySorozatMa.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtVersenySorozatHo.Text);
                }
                catch {
                    txtVersenySorozatHo.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtVersenySorozatMe.Text);
                }
                catch {
                    txtVersenySorozatMe.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
            ...
            if (txtHelyezesSze.Text != "") {
                ...
                try {
                    Convert.ToInt32(txtHelyezesSze.Text);
                }
                catch {
                ...
                try {
                    Convert.ToInt32(txtHelyezesMa.Text);
                }
                catch {
                    txtHelyezesMa.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtHelyezesHo.Text);
                }
                catch {
                    txtHelyezesHo.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
                ...
                try {
                    Convert.ToInt32(txtHelyezesMe.Text);
                }
                catch {
                    txtHelyezesMe.BorderBrush = new SolidColorBrush(Colors.Red);
                    valid = false;
