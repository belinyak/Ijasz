...
namespace Ijasz2.Megjelenites.Oklevel {
    ...
    /// </summary>
    public partial class Sablon_Hozzaadas_Modositas {
        private readonly Sablon _sablon;
        ...
        private bool IsValid( ) {
            ...
            if( txtVersenySze.Text != "" ) {
                if( txtVersenyMa.Text == "" ) {
                    txtVersenyMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( txtVersenyHo.Text == "" ) {
                    txtVersenyHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                int temp;
                if( !Int32.TryParse( txtVersenySze.Text, out temp ) ) {
                    txtVersenySze.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( !Int32.TryParse( txtVersenyMa.Text, out temp ) ) {
                    txtVersenyMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                if( !Int32.TryParse( txtVersenyHo.Text, out temp ) ) {
                    txtVersenyHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                ...
                if( txtVersenyMe.Text == "" ) {
                    txtVersenyMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                if( !Int32.TryParse( txtVersenyMe.Text, out temp ) ) {
                    txtVersenyMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
            ...
            if( txtVersenySorozatSze.Text != "" ) {
                if( txtVersenySorozatMa.Text == "" ) {
                    txtVersenySorozatMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( txtVersenySorozatHo.Text == "" ) {
                    txtVersenySorozatHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                int temp;
                if( !Int32.TryParse( txtVersenySorozatSze.Text, out temp ) ) {
                    txtVersenySorozatSze.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                if( !Int32.TryParse( txtVersenySorozatMa.Text, out temp ) ) {
                    txtVersenySorozatMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( !Int32.TryParse( txtVersenySorozatHo.Text, out temp ) ) {
                    txtVersenySorozatHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                ...
                if( txtVersenySorozatMe.Text == "" ) {
                    txtVersenySorozatMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( !Int32.TryParse( txtVersenySorozatMe.Text, out temp ) ) {
                    txtVersenySorozatMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                ...
                if( chVersenySorozatLe.IsChecked == false && chVersenySorozatRi.IsChecked == false &&
                    chVersenySorozatMi.IsChecked == false ) {
            ...
            if( txtHelyezesSze.Text != "" ) {
                if( txtHelyezesMa.Text == "" ) {
                    txtHelyezesMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( txtHelyezesHo.Text == "" ) {
                    txtHelyezesHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                int temp;
                if( !Int32.TryParse( txtHelyezesSze.Text, out temp ) ) {
                    txtHelyezesSze.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                if( !Int32.TryParse( txtHelyezesMa.Text, out temp ) ) {
                    txtHelyezesMa.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                if( !Int32.TryParse( txtHelyezesHo.Text, out temp ) ) {
                    txtHelyezesHo.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                ...
                if( txtHelyezesMe.Text == "" ) {
                    txtHelyezesMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }

                if( !Int32.TryParse( txtHelyezesMe.Text, out temp ) ) {
                    txtHelyezesMe.BorderBrush = new SolidColorBrush( Colors.Red );
                    valid = false;
                }
                ...
                if( chHelyezesLe.IsChecked == false && chHelyezesRi.IsChecked == false &&
                    chHelyezesMi.IsChecked == false ) {
            ...
            if( txtEgyesuletSze.Text != "" ) {
                ...
                if( chEgyesuletLe.IsChecked == false && chEgyesuletRi.IsChecked == false &&
                    chEgyesuletMi.IsChecked == false ) {
            ...
            if( txtKorosztalySze.Text != "" ) {
                ...
                if( chKorosztalyLe.IsChecked == false && chKorosztalyRi.IsChecked == false &&
                    chKorosztalyMi.IsChecked == false ) {
            ...
            if( txtInduloNemeSze.Text != "" ) {
                ...
                if( chInduloNemeLe.IsChecked == false && chInduloNemeRi.IsChecked == false &&
                    chInduloNemeMi.IsChecked == false ) {
